...
import { userProfileData } from "../../libs/data/dummy";
...
const UserProfile = () => {
  ...
  return (
    <div className="FadeAp nav-item absolute right-1 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        ...
        <Button
          ...
          size="2xl"
          borderRadius="50%"
          onClick={() => toggleIsClicked("userProfile", false)}
        >
          <MdOutlineCancel />
        </Button>
      </div>
